    ...
    $('#booking-form').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                submitBtn.html('Request Booking').attr('disabled', false); // Reset button text and enable button
            ...
            error: function() {
                ...
                submitBtn.html('Book Ride').attr('disabled', false); // Reset button text and enable button
            }
        });
    });
});